...
export function OrderListPage(props: OrderListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrders({
        relations: ['user_order_customer_idTouser', 'user_order_delivery_personnel_idTouser', 'order_item.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_order_delivery_personnel_idTouser',
          header: 'User Order Delivery Personnel Id Touser',
          accessorKey: 'user_order_delivery_personnel_idTouser',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/users/view/${record.user_order_delivery_personnel_idTouser?.id}`}
            >
